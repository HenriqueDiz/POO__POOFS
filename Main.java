...
public class Main {
    public static void main(String[] args) {
        ...
        produtos.add(new ProdutoAlimentarTaxaReduzida("003", "Leite", "Leite Integral", 30, 0.8, false, 15)); // 15 = 1111 in binary, meaning all certifications
        ...
        while (true) {
            ...
            System.out.println("6. Listar todas faturas na aplicação");
            ...
            switch (opcao) {
                ...
                case 7 -> {
                    gestaoFaturas.visualizarFatura();
                }
                case 8 -> {
